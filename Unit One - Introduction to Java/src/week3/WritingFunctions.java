...
public class WritingFunctions {
    public static void main(String[] args) {
        ...
        // A function/method performs a specific task (and can return a value)
     ...
     * @return returns the slope of the two points
     */
    ...
    /*
    * num1 is a copy of x and any changes to num1 do not affect x becasue the params are primitive 
    */
